...
<p align="center">
  ...
  &nbsp;|&nbsp;
  <a href="#contribution-history">Contributions</a>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/MrBoodj011/CBS_Mail/main/assets/cbs-mail-desktop.png" alt="CBS Mail desktop interface" width="73%">
  &nbsp;
  <img src="https://raw.githubusercontent.com/MrBoodj011/CBS_Mail/main/assets/cbs-mail-mobile.png" alt="CBS Mail mobile interface" width="23%">
</p>

<p align="center">
  <strong>Responsive by design:</strong> a focused desktop workspace and a
  touch-friendly mobile mailbox.
</p>
...
| **Roundcube Plugin** | Plugin hooks, asset loading, trusted senders, trusted domains, and user preference integration. |
| **Labels** | Per-user synchronized email labels with assignment, filtering, counts, and migration support. |
| **PWA** | Manifest, installable app experience, icons, safe offline fallback, and service worker behavior. |
| **Deployment** | Docker image overlay, Compose setup, environment templates, and production guidance. |
| **Quality** | Browser tests, security checks, CSS checks, CI workflows, and project documentation. |
...
<p align="center">
  ...
  <img alt="Playwright" src="https://img.shields.io/badge/Playwright-Testing-2EAD33?style=for-the-badge&logo=playwright&logoColor=white">
