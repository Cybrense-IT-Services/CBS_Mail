...
- Removed the compose grid track that caused narrow screens to reserve a large blank area and aligned the form, editor, and send controls as one responsive column.
...
- Made health checks content-aware so HTTP 200 error pages cannot report healthy.
...
- Fixed mobile recipient chips so long contact names wrap cleanly instead of being clipped.
